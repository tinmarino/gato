...
\personal
    []
    {13, rue Neuve, 6900, Lyon}
    {+33 07 81 14 32 25}
    {cr.vegac@gmail.com}
\end{textblock}

\begin{textblock}{21}(0,1)
     \centering{\headerfirstnamestyle{Cynthia}   \headerlastnamestyle{Vega}}
\end{textblock}
