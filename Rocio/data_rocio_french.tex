...
\item[Sénat du Chili]{Avril 2014 -- Mars 2015}
     {Attachée de presse}
	 {
			\mission{Contexte :} Le cabinet politique du sénateur \url{http://harboesenador.cl/}{Felipe Harboe} cherche continuement à améliorer sa visibilité et présence dans les médias \\ 
			\mission{Missions :} 
...
\item[Productrice générale]{Mai 2013 -- Déc. 2014}
	 ...
	 {	
		\mission{Contexte :} La maison de production indépendante Aluro 35 doit produire le programme culturel de télévision \url{http://www.13.cl/c/programas/la-bicicleta}{La Bicicleta} transmit par la chaîne 13C \\
		\mission{Missions :}
