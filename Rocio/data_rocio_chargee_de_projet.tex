...
\tbfskilltwo{Logiciel}{
	$\textbullet$ Système opératif : Linux - Windows  		\\
...
\tbfskilltwo{Savoir-faire}{
	$\textbullet$ \raggedrigth Création et mise en oeuvre des stratégies de communication \\
	$\textbullet$ \raggedrigth Préparation et rédaction de rapports, communiqués et articles de presse \\
	$\textbullet$ \raggedrigth Maîtrise des réseaux sociaux \\
	$\textbullet$ \raggedrigth Gestion de projet \\
}
