...
\item[Master de Théorie politique]{2017 -- 2018}
...
\tbfskilltwo{Logiciels}{
	$\textbullet$ Système opératif : Windows - Linux 		\\
	$\textbullet$ Bureautique : Libre Office - Microsoft Office		\\
	%$\textbullet$ PAO: Adobe Photoshop - InDesign 	\\
	$\textbullet$ Edition : Gimp - Git - \LaTeX.
}

\tbfskilltwo{Savoir-faire}{
	$\textbullet$ Création et mise en oeuvre des stratégies de communication \\
	$\textbullet$ Préparation et rédaction de rapports, communiqués et articles de presse \\
