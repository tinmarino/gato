...
\newenvironmentx{yearlist}[3][1=7.1, 2=0.7, 3=3.9]{
    ...
    \ifx\HCode\undefined\else
        \HCode{<div class="textcustomblock" style="display: inline-block; width:100\%; margin-left: 45px; margin-top: 261px;">\Hnewline</div>\Hnewline}
    \fi
    % Create my space
