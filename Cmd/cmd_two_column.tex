...
% 1/ Commands
\newcommand\tbflogo[1]{
    \includegraphics[width=0.35cm, height=0.35cm]{#1}
}
...
\newenvironmentx{joblist}{
	\begin{flat_frame}{\wordwork}{13.2}{7.8}{3.9}{}
	\relscale{1.27}
	\renewcommand\item[4][]{
		\vspace*{0.3cm}
...
\newenvironment{yearlist}{
	\begin{rounded_frame}{\wordeducation}{7.1}{0.7}{3.9}{}
	\relscale{1.2}
    \renewcommand\item[4][]{
		\textsc{\bodyfont{##2}}                                     % YEAR
            \hspace*{0.2cm}                                          % TODO align them because letter 0 takes more space then 1
...
\newenvironment{skilllist}{
	\begin{rounded_frame}{\wordlanguage}{ 7.1 } { 0.7 }{ 14.8 }{}
	\relscale{1.2}
}{
	\end{rounded_frame}
}
