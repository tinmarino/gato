...
\else
    \usepackage[overlay]{textpos}               % Textblock
    \setlength{\TPHorizModule}{28pt}
    \setlength{\TPVertModule}{28pt}
    \usepackage{calc}                           % New lenght
\fi
...
\else
    \def\@tbfblock#1(#2, #3){
        \pgfmathsetmacro{\tmpwidth}{#1 / 21 * 100}
        \pgfmathsetmacro{\tmpleft}{#2 / 21 * 100}
        \pgfmathsetmacro{\tmptop}{#3 / 29.7 * 100}
