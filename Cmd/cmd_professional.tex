...
\newcommand\tbfimflag[1]{
    \includegraphics[height=0.3cm]{#1}\phantom{\tiny{1}}}
...
\newcommand\tbfbirth[1]{
    \PersonalEntry{\includegraphics[height=12pt]{../Figure/logo/birthday1_white_128.png}}{#1}
}
\newcommand\tbfmail[1]{
    \PersonalEntry{\emojifont ✉}{#1}
}
...
\newcommand\tbfwww[1]{
    \PersonalEntry{\includegraphics[height=12pt]{../Figure/logo/www_base3_128.png}}{#1}
}
