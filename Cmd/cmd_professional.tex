...
\newcommand\tbfflag[1]{
    \PersonalEntry{\includegraphics[height=10pt]{../Figure/flag.png}}{#1}
}
\newcommand\tbfbirth[1]{
    \PersonalEntry{\includegraphics[height=10pt]{../Figure/logo/birthday1_128.png}}{#1}
}
\newcommand\tbfmail[1]{
...
\newcommand\tbfwww[1]{
    \PersonalEntry{\includegraphics[height=10pt]{../Figure/logo/www_128.png}}{#1}
}
