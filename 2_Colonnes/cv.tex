...
\item{\color{text} Avril 2014 -- Mars 2015}
     ...
     \makebox[1.4cm][l]{Contexte :} Le cabinet politique du sénateur \Myhref{http://harboesenador.cl/}{Felipe Harboe} cherche continuement à améliorer sa visibilité et présence dans les médias \\ 
...
\item{Mai 2013 -- Déc. 2014}
     ...
     \fontsize{9pt}{1em}\color{text}\bodyfontlight\upshape\selectfont
    \makebox[1.4cm][l]{Contexte :} La maison de production indépendante Aluro 35 doit produire le programme culturel de télévision \Myhref{http://www.13.cl/c/programas/la-bicicleta}{La Bicicleta} transmit par la chaîne 13C \\
    \makebox[1.4cm][l]{Missions :}
...
\end{itemize}       
\makebox[1.4cm][l]{Résultats:} Présence constante dans la presse nationale
\vspace{0.5cm}
