...
\item{Avril 2014 -- Mars 2015}
  ...
  \setlength{\parskip}{-10pt}
    \begin{itemize}
      ...
      \cvitem[\checkmark]  \descriptionstyle{ Chargée de la mise en œuvre des actions de communication et des relations avec la presse nationale et régionale                      }
      \cvitem[\checkmark]  \descriptionstyle{ Rédaction des articles, communiqués et dossiers de presse. Gestion et supervision des interviews avec des chaînes de télévision      }
      \cvitem[\checkmark]  \descriptionstyle{ Organisation des conférences de presse                                                                                               }
      \cvitem[\checkmark]  \descriptionstyle{ Administration de réseaux sociaux conjointement avec l’administrateur du site web                                                    }
    \end{itemize}     
     \descriptionstyle{ 
    Résultat : Présence constante dans la presse nationale et régionale (télévision, radio et journaux). \\
...
Mission :
    ...
    \begin{itemize}
      \setlength\itemsep{-3pt} 
      \cvitem[\checkmark] \descriptionstyle{ Gérer les rapports avec la chaîne de télévision et négociation avec eux les budgets. Recherche des marques sponsors                          }
      ...
      \cvitem[\checkmark] \descriptionstyle{ Création du dossier de presse pour les lancements des deux premières sessions du programme                                                   }

    \end{itemize}     
   \descriptionstyle{  
Après le succès de la première saison la chaîne 13C propose une deuxième saison avec une augmentation des sponsors.  \\
Important visibilité aux artistes ou associations culturels qui ont été interviewés et qui  n’appartient pas au milieu culturel officielle \\
Gagnants d’un « Fondart » (fond public du Conseil de Culture et Communication) pour réaliser une troisième saison.  \\
     }
...
\begin{itemize}
      ...
      \cvitem[\checkmark] \descriptionstyle{ Préparation des articles pour les médias                                            }
      \cvitem[\checkmark] \descriptionstyle{ Création des dossiers de presse                                                     }
      \cvitem[\checkmark] \descriptionstyle{ Cibler les journalistes spécialisés et améliorer régulièrement la basse de donnés.  }
      \cvitem[\checkmark] \descriptionstyle{ Relances téléphoniques                                                              }
\end{itemize}       
...
\begin{itemize}
      \setlength\itemsep{0cm} 
      \cvitem[\checkmark]  \descriptionstyle{ Recherche des informations juridiques et environnementales des projets similaires dans le cadre national ou internationale                   }
      \cvitem[\checkmark]  \descriptionstyle{ Gestion et coordination des réunions chaque semaine avec les membres de la corporation, plus la préparation des matériaux visuel et écrit    }
