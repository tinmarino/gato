...
\fontsize{10pt}{1.5em}\color{text}\bodyfontlight\upshape\selectfont
	...
	{\fontsize{14pt}{5em}\scshape\bfseries Traductrice, relectrice et rédactrice Fashion Network \\} 
...
\begin{itemize}[leftmargin=13pt]
  \cvitem[\checkmark]  Traduction du Français vers l'espagnol
...
\mission{Missions :} 
    ...
    \begin{itemize}
      ...
      \cvitem[\checkmark] Rédaction et correction des articles, communiqués et dossiers de presse
      \cvitem[\checkmark] Suivi et relances du contenu envoyé à la presse
      \cvitem[\checkmark] Gérer contenu du site web et veille médiatique
