...
\fontsize{10pt}{1.5em}\color{text}\bodyfontlight\upshape\selectfont
	...
	{\fontsize{14pt}{5em}\scshape\bfseries Chargée de communication marchés étrangers \\} 
...
\begin{itemize}[leftmargin=13pt]
  \cvitem[\checkmark]  Stratégies et plans de communication
  \cvitem[\checkmark]  Préparation et rédaction de communiqués et articles de presse
  \cvitem[\checkmark]  Maîtrise de réseaux sociaux et système de gestion de contenu
  \cvitem[\checkmark]  Gestion et soutien de relations presse
\end{itemize}
